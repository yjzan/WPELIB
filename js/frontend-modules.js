...
exports.default = window.yjzanModules = {
...
module.exports = yjzanModules.ViewModule.extend({
	getDefaultSettings: function getDefaultSettings() {
		return {
			element: null,
			direction: yjzanFrontend.config.is_rtl ? 'right' : 'left',
			selectors: {
				container: window
			}
		};
...
module.exports = yjzanModules.ViewModule.extend({
	...
	__construct: function __construct(settings) {
		...
		this.isEdit = this.$element.hasClass('yjzan-element-edit-mode');
	...
	findElement: function findElement(selector) {
		...
		return $mainElement.find(selector).filter(function () {
			return jQuery(this).closest('.yjzan-element').is($mainElement);
		});
	},
	...
	initEditorListeners: function initEditorListeners() {
		...
		['page', 'general'].forEach(function (settingsType) {
			...
			if (self[listenerMethodName]) {
				self.editorListeners.push({
					event: 'change',
					to: yjzan.settings[settingsType].model,
	...
	addEditorListeners: function addEditorListeners() {
		...
		this.getEditorListeners().forEach(function (listener) {
			yjzanFrontend.addListenerOnce(uniqueHandlerID, listener.event, listener.callback, listener.to);
		});
	},
	...
	removeEditorListeners: function removeEditorListeners() {
		...
		this.getEditorListeners().forEach(function (listener) {
			yjzanFrontend.removeListeners(uniqueHandlerID, listener.event, null, listener.to);
		});
	},
	...
	getElementSettings: function getElementSettings(setting) {
		...
		if (this.isEdit && modelCID) {
			var settings = yjzanFrontend.config.elements.data[modelCID],
			...
			var settingsKeys = yjzanFrontend.config.elements.keys[type];

			if (!settingsKeys) {
				settingsKeys = yjzanFrontend.config.elements.keys[type] = [];
	...
	getEditSettings: function getEditSettings(setting) {
		...
		if (this.isEdit) {
			attributes = yjzanFrontend.config.elements.editSettings[this.getModelCID()].attributes;
		}
	...
	getCurrentDeviceSetting: function getCurrentDeviceSetting(settingKey) {
		return yjzanFrontend.getCurrentDeviceSetting(this.getElementSettings(), settingKey);
	},
