...
/******/ ({
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var YjzanCommonApp = function (_yjzanModules$Vie) {
            _inherits(YjzanCommonApp, _yjzanModules$Vie);

            function YjzanCommonApp() {
                _classCallCheck(this, YjzanCommonApp);

                return _possibleConstructorReturn(this, (YjzanCommonApp.__proto__ || Object.getPrototypeOf(YjzanCommonApp)).apply(this, arguments));
            }

            _createClass(YjzanCommonApp, [{
                ...
                value: function onInit() {
                    _get(YjzanCommonApp.prototype.__proto__ || Object.getPrototypeOf(YjzanCommonApp.prototype), 'onInit', this).call(this);

                    this.config = yjzanCommonConfig;

                    this.setMarionetteTemplateCompiler();
                }
            }]);

            return YjzanCommonApp;
        }(yjzanModules.ViewModule);

        window.yjzanCommon = new YjzanCommonApp();

        yjzanCommon.initComponents();
            ...
            _createClass(_class, [{
                ...
                value: function send(action, options) {
                    ...
                    var settings = this.getSettings(),
                        ajaxParams = yjzanCommon.helpers.cloneObject(settings.ajaxParams);
                    ...
                    var requestConstants = yjzanCommon.helpers.cloneObject(this.requestConstants);
        ...
        var _class = function (_yjzanModules$Mod) {
            ...
            _createClass(_class, [{
                ...
                value: function addShortcut() {
                    ...
                    yjzanCommon.hotKeys.addHotKeyHandler(E_KEY, 'finder', {
                ...
                key: 'onInit',
                value: function onInit() {
                    this.channel = Backbone.Radio.channel('YJZAN:finder');
        ...
        var _class = function (_yjzanModules$com) {
            ...
            _createClass(_class, [{
                ...
                value: function showModal() {
                    ...
                    if(this.modalContent.currentView.ui.searchInput.val()=='')
                    {
                        this.modalContent.currentView.ui.searchInput.val(' ');
                        this.modalContent.currentView.onSearchInputInput();
                    }
                }
            }, {
                key: 'loadPageData',
        ...
        var _class = function (_Marionette$LayoutVie) {
            ...
            _createClass(_class, [{
                ...
                value: function getTemplate() {
                    return '#tmpl-yjzan-finder';
                }
            }, {
                key: 'ui',
                value: function ui() {
                    return {
                        searchInput: '#yjzan-finder__search__input'
                    };
                }
            }, {
                key: 'events',
                ...
                value: function onSearchInputInput() {
                    ...
                    if (value) {
                        yjzanCommon.finder.channel.reply('filter:text', value).trigger('filter:change');
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var _class = function (_Marionette$Composite) {
            ...
            _createClass(_class, [{
                key: 'id',
                value: function id() {
                    return 'yjzan-finder__results-container';
                }
            }, {
                key: 'ui',
                value: function ui() {
                    return {
                        noResults: '#yjzan-finder__no-results',
                        categoryItem: '.yjzan-finder__results__item'
                    };
                }
            }, {
                key: 'events',
                ...
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-finder-results-container';
                }
            }, {
                key: 'getChildView',
                ...
                value: function initialize() {
                    ...
                    this.childViewContainer = '#yjzan-finder__results';

                    this.collection = new Backbone.Collection(Object.values(yjzanCommon.finder.getSettings('data')));
                ...
                value: function activateItem($item) {
                    if (this.$activeItem) {
                        this.$activeItem.removeClass('yjzan-active');
                    }

                    $item.addClass('yjzan-active');
                ...
                value: function goToActiveItem(event) {
                    var $a = this.$activeItem.children('a'),
                        isControlClicked = yjzanCommon.hotKeys.isControlEvent(event);
                ...
                value: function addHotKeys() {
                    ...
                    yjzanCommon.hotKeys.addHotKeyHandler(DOWN_ARROW, 'finderNextItem', {
                        isWorthHandling: function isWorthHandling() {
                            return yjzanCommon.finder.getLayout().getModal().isVisible();
                        },
                        handle: function handle() {
                    ...
                    yjzanCommon.hotKeys.addHotKeyHandler(UP_ARROW, 'finderPreviousItem', {
                        isWorthHandling: function isWorthHandling() {
                            return yjzanCommon.finder.getLayout().getModal().isVisible();
                        },
                        handle: function handle() {
                    ...
                    yjzanCommon.hotKeys.addHotKeyHandler(ENTER, 'finderSelectItem', {
                        isWorthHandling: function isWorthHandling() {
                            return yjzanCommon.finder.getLayout().getModal().isVisible() && _this2.$activeItem;
                        },
        ...
        var _class = function (_Marionette$ItemView) {
            ...
            _createClass(_class, [{
                ...
                value: function className() {
                    return 'yjzan-finder__results__item';
                }
            }, {
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-finder__results__item';
                }
            }]);
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var _class = function (_Category) {
            ...
            _createClass(_class, [{
                key: 'className',
                value: function className() {
                    return _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'className', this).call(this) + ' yjzan-finder__results__category--dynamic';
                }
            }, {
                key: 'ui',
                value: function ui() {
                    return {
                        title: '.yjzan-finder__results__category__title'
                    };
                }
            }, {
                key: 'fetchData',
                value: function fetchData() {
                    ...
                    yjzanCommon.ajax.addRequest('finder_get_category_items', {
                        data: {
        ...
        var _class = function (_yjzanModules$Vie) {
            ...
            _createClass(_class, [{
                ...
                value: function addPopupPlugin() {
                    jQuery.fn.yjzanConnect = function (options) {
                        ...
                        yjzanCommon.elements.$window.on('yjzanConnected', settings.callback);
                ...
                value: function getDefaultSettings() {
                    return {
                        selectors: {
                            connectPopup: '.yjzan-connect-popup'
                        }
                    };
                }
            }, {
                ...
                value: function applyPopup() {
                    this.elements.$connectPopup.yjzanConnect();
                }
            }, {
                key: 'onInit',
                value: function onInit() {
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var _class = function (_Marionette$Composite) {
            ...
            _createClass(_class, [{
                key: 'className',
                value: function className() {
                    return 'yjzan-finder__results__category';
                }
            }, {
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-finder__results__category';
                }
            }, {
                key: 'getChildView',
                ...
                key: 'initialize',
                value: function initialize() {
                    this.childViewContainer = '.yjzan-finder__results__category__items';
                ...
                value: function getTextFilter() {
                    return yjzanCommon.finder.channel.request('filter:text').trim().toLowerCase();
                }
            }, {
                key: 'toggleElement',
                ...
                key: 'onRender',
                value: function onRender() {
                    this.listenTo(yjzanCommon.finder.channel, 'filter:change', this.onFilterChange.bind(this));
                }
            }, {
                key: 'onFilterChange',
                value: function onFilterChange() {
