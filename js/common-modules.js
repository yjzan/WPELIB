        ...
        var _class = function (_Marionette$LayoutVie) {
            ...
            _createClass(_class, [{
                ...
                value: function initModal() {
                    var modalOptions = {
                        className: 'yjzan-templates-modal',
                        closeButton: false,
                        draggable: false,
                        hide: {
                    ...
                    this.modal = yjzanCommon.dialogsManager.createWidget('lightbox', modalOptions);
        ...
        var _class = function (_Marionette$LayoutVie) {
            ...
            _createClass(_class, [{
                ...
                value: function className() {
                    return 'yjzan-templates-modal__header';
                }
            }, {
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-templates-modal__header';
                }
            }, {
                key: 'regions',
                value: function regions() {
                    return {
                        logoArea: '.yjzan-templates-modal__header__logo-area',
                        tools: '#yjzan-template-library-header-tools',
                        menuArea: '.yjzan-templates-modal__header__menu-area'
                    };
                }
            }, {
                key: 'ui',
                value: function ui() {
                    return {
                        closeModal: '.yjzan-templates-modal__header__close'
                    };
                }
            }, {
                key: 'events',
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var _class = function (_Marionette$ItemView) {
            ...
            _createClass(_class, [{
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-templates-modal__header__logo';
                }
            }, {
                key: 'className',
                value: function className() {
                    return 'yjzan-templates-modal__header__logo';
                }
            }, {
                key: 'events',
                value: function events() {
	...
	/***/ (function(module, exports, __webpack_require__) {
        ...
        var _class = function (_Marionette$ItemView) {
            ...
            _createClass(_class, [{
                key: 'id',
                value: function id() {
                    return 'yjzan-template-library-loading';
                }
            }, {
                key: 'getTemplate',
                value: function getTemplate() {
                    return '#tmpl-yjzan-template-library-loading';
                }
            }]);
