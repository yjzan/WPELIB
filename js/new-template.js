...
/******/ ({
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var NewTemplateModule = yjzanModules.ViewModule.extend({

            getDefaultSettings: function getDefaultSettings() {
                return {
                    selectors: {
                        addButton: '.page-title-action:first, #yjzan-template-library-add-new'
                    }
                };
            },
            ...
            bindEvents: function bindEvents() {
                ...
                yjzanCommon.elements.$window.on('hashchange', this.showModalByHash.bind(this));
            },
        ...
        jQuery(function () {
            window.yjzanNewTemplate = new NewTemplateModule();
        });
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        module.exports = yjzanModules.common.views.modal.Layout.extend({
            ...
            getModalOptions: function getModalOptions() {
                return {
                    id: 'yjzan-new-template-modal'
                };
            },

            getLogoOptions: function getLogoOptions() {
                return {
                    title: yjzanAdmin.translate('new_template')
                };
            },

            initialize: function initialize() {
                yjzanModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        module.exports = Marionette.ItemView.extend({
            ...
            id: 'yjzan-new-template-dialog-content',

            template: '#tmpl-yjzan-new-template',
